	 ...
	 fiches["2-0"] = new CarteActionSpeciale("Départ",function(){joueurCourant.gagner(40000)},2,0);
	 ...
	 function CarteCaisseDeCommunaute(libelle,actionCC){
	   this.action = function(){
		return createMessage("Caisse de communauté","pink",libelle,function(param){actionCC.action();changeJoueur();},{});
	   }
	 }
	 ...
	 function CaisseDeCommunaute(etat,pos){
	  this.case = new Case(pos,etat,null,"Caisse de communauté",null,{src:"banque.png",width:50,height:50});
	  Drawer.add(this.case);
	    this.action = function(){
	  ...
	  function rand(){
	   ...
	   function lancerDes(){
		...
		function init(){
		  ...
		  // panneau de création
		  $('#achatMaisons').dialog({autoOpen:false,title:"Achat de maisons / hôtels",width:500,height:300});
